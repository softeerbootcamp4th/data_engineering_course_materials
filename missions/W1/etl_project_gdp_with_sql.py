...
log_path = settings['file_path']['log_path']
region_data_json_path = settings['file_path']['region_data_json_path']
GDP_json_path = settings['file_path']['GDP_json_path']
db_path = settings['file_path']['db_path']
