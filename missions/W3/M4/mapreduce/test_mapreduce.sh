...
copy_file ../untracked/training.1600000.processed.noemoticon.csv $HADOOP_HOME/mapreduce_test
# end ##################################
...
docker exec -it $CONTAINER_NAME bash -c "
  ...
  chmod +x $HADOOP_HOME/mapreduce_test/training.1600000.processed.noemoticon.csv
  chmod +x $HADOOP_HOME/mapreduce_test/wordcount.sh
  chmod +x $HADOOP_HOME/mapreduce_test/mapper.py
  chmod +x $HADOOP_HOME/mapreduce_test/reducer.py
  "
